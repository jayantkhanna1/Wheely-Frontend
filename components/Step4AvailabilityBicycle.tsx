      ...
      <View style={styles.calendar}>
        ...
        <View style={styles.calendarGrid}>
          {days.map((day, index) => {
            ...
            const dayStyles = [styles.calendarDay] as any[];
            ...
            const textStyles = [styles.calendarDayText] as any[];
            if (day && isDateSelected(day)) {
            ...
            <View style={styles.allDayContainer}>
              <View style={styles.allDayIndicator}>
                ...
                <Text style={styles.allDayDescription}>
                  Your bicycle will be available for booking at any time on the selected dates
                </Text>
              </View>
            </View>
          ) : (
