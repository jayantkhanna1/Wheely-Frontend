  ...
  const bikes: Bike[] = [
    {
      ...
      features: ['Automatic', 'Petrol', '2 Seats', 'Scooter']
    },
    {
      id: '2',
      name: 'TVS',
      ...
      price: 42,
      image: 'https://images.pexels.com/photos/1119796/pexels-photo-1119796.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&fit=crop',
      features: ['Automatic', 'Petrol', '2 Seats', 'Scooter']
    },
    {
      id: '3',
      ...
      price: 65,
      image: 'https://images.pexels.com/photos/2116475/pexels-photo-2116475.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&fit=crop',
      features: ['Manual', 'Petrol', '2 Seats', 'Sport']
    },
    {
      id: '4',
      name: 'Hero',
      ...
      price: 38,
      image: 'https://images.pexels.com/photos/1119796/pexels-photo-1119796.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&fit=crop',
      features: ['Manual', 'Petrol', '2 Seats', 'Commuter']
    },
    {
      id: '5',
      name: 'Bajaj',
      ...
      <View style={styles.bikeInfo}>
        ...
        <View style={styles.bikeDetails}>
          <View style={styles.bikeDetailItem}>
            ...
            <Text style={styles.bikeDetailText}>{item.rating}</Text>
          </View>
